...
Không còn bước build MinkowskiEngine hoặc pointnet2. VGN chạy qua TensorRT engine build trên target Jetson. Nếu JetPack/Python/Torch hoặc TensorRT version thay đổi, tạo lại `.venv` và build lại `model/vgn.engine`.
